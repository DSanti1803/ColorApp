import 'package:color_app/presentacion/pantallas/pantalla_juego_personalizado.dart';
...
class _JuegoPersonalizadoState extends State<JuegoPersonalizado> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                const Text('Tiempo de juego (segundos):', style: TextStyle(fontSize: 18)), // Texto para el selector de tiempo
                DropdownButton<int>(
  ...
  MaterialPageRoute(
    builder: (context) => PantallaJuegoPersonalizado(tiempo: tiempo, vidas: vidas),
           ),
            );
              },
