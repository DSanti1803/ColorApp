...
class PantallaJuegoPersonalizado extends StatefulWidget {
  final int tiempo;
  final int vidas;

  const PantallaJuegoPersonalizado({super.key, required this.tiempo, required this.vidas});

  @override
  State<PantallaJuegoPersonalizado> createState() => _PantallaJuegoPersonalizadoState();
}

class _PantallaJuegoPersonalizadoState extends State<PantallaJuegoPersonalizado> {
  @override
  void didChangeDependencies() {
    super.didChangeDependencies();
    final juegoLogica = Provider.of<JuegoLogica>(context, listen: false);
    WidgetsBinding.instance.addPostFrameCallback((_) {
      juegoLogica.reiniciarJuego(customTime: widget.tiempo, customLives: widget.vidas);
    });
    } 
...
@override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Juego de Colores', style: TextStyle(color: Colors.white),), // Título de la barra de aplicaciones
